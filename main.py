...
st.write("- Necroza tumorala sau Centrul tumorei: Parte a tumorei formate din celule ce au murit datorită vascularizării scăzute cauzate de extinderea tumorii")
st.write("- Edemul: Este o inflamație a țesutului nervos cauzată de extinderea tumorii și duce la acumularea de lichid în creieri. Poate apărea și în lipsa unei tumori atunci când este consecința unui atac cerebral sau a unei leziuni. Presiunea și infiltrarea lichidului în alte părți ale creierului duce la dureri de cap , crize de epilepsie, amețeli, probleme de vedere sau de vorbire și la distugerea celulelor sănătoase ce nu au fost afectate încă de tumoră")
st.write("- Enhancing: Este zona ce nu poate fi detectată ușor de către RMN și adesea necesită administrarea de fluid de contrast. Apare ca urmare a extinderii tumorelor și ne poate oferii informații despre viteza cu care se extinde tumora către țesuturile sănătoase și despre gravitatea tumorei.")
